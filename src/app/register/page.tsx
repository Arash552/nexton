    ...
    <body>
      ...
      <main className="sm:w-96 px-5 mb-10 mx-auto">
        <div className="w-full flex flex-col gap-y-5">
          <p className="text-xl text-black font-bold mx-auto">Register</p>
          ...
          <div className="w-full grid gap-y-2">
            <p className="text-black text-sm font-semibold">Password (Again)</p>
            <input
              type="password"
              className="w-full text-sm h-12 border-2 border-borderC bg-none outline-none p-2 rounded-2xl"
            />
          ...
          <div className="flex gap-x-1 mx-auto">
            <p className="text-sm text-tGray">Already a member?</p>
            <Link href="/login" className="text-sm text-blue no-underline">
              Login
            </Link>
          </div>
        </div>
